...
TEST(Solve, solve_1to4_convergence) {
    ...
    for (auto& problem_ID : problem_IDs) {
        ...
        for (auto& N : Ns) {
            ...
            // std::cout << "[unittest_solve::solve_1to4_convergence]  Computing RHS vectors `f`..." << std::endl;
            ...
            // std::cout << "[unittest_solve::solve_1to4_convergence]  Computing particular solution vectors `w`..." << std::endl;
            ...
            // std::cout << "[unittest_solve::solve_1to4_convergence]  Computing Neumann data for particular solution `h`..." << std::endl;
            ...
            //    Alpha
            // std::cout << "[unittest_solve::solve_1to4_convergence]  Checking alpha..." << std::endl;
            // printf("  X             Y             EXACT         APPROX        DIFF          MAX_ERROR\n");
            // printf("------------  ------------  ------------  ------------  ------------  ------------\n");
            ...
            //    Beta
            // std::cout << "[unittest_solve::solve_1to4_convergence]  Checking beta..." << std::endl;
            // printf("  X             Y             EXACT         APPROX        DIFF          MAX_ERROR\n");
            // printf("------------  ------------  ------------  ------------  ------------  ------------\n");
            ...
            //    Gamma
            // std::cout << "[unittest_solve::solve_1to4_convergence]  Checking gamma..." << std::endl;
            // printf("  X             Y             EXACT         APPROX        DIFF          MAX_ERROR\n");
            // printf("------------  ------------  ------------  ------------  ------------  ------------\n");
            ...
            //    Omega
            // std::cout << "[unittest_solve::solve_1to4_convergence]  Checking omega..." << std::endl;
            // printf("  X             Y             EXACT         APPROX        DIFF          MAX_ERROR\n");
            // printf("------------  ------------  ------------  ------------  ------------  ------------\n");
